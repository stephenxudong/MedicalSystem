...
<head>
    ...
    <meta name="keyword" content="深度学习" />
...
<div id="main_mid" class="mid">
    ...
    <div id="main_mid_signup" class="signup">
        ...
        <form id="sign_up_form" name="login_form" class="form" action="/dddemo/userlogin/login" method="post">
            ...
            <canvas id="code" style="float: left;width:20%;height:50px;margin-top:22px;margin-left:5%;border: 1px white solid;background-color: white;" onclick="Redraw()"></canvas>
